//package cn.cloudworkshop.customtailor.utils;
//
...
//     * @return 检测矩形
//     */
//    public static Map<String,String> findRectangles(Bitmap bitmap) {
//        //轮廓面积
//        double maxArea = 0.0;
//        //
...
//        Imgproc.adaptiveThreshold(gray, gray, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C, Imgproc.THRESH_BINARY_INV, 33, 7);
//
//        List<MatOfPoint> contours = new ArrayList<>();
//        //寻找所有轮廓
//        Imgproc.findContours(gray, contours, new Mat(), Imgproc.RETR_LIST, Imgproc.CHAIN_APPROX_SIMPLE);
//        Imgcodecs.imwrite(Environment.getExternalStorageDirectory().getAbsolutePath() +
//                "/CloudWorkshop/camera" + System.currentTimeMillis() + ".jpg", gray);
//        //对寻找到的轮廓遍历
...
//
//        if (maxArea > 0) {
//            String scale = df.format(21 / Math.sqrt(maxArea / Math.sqrt(2)) * 60 / 66.5);
...
//
//
//    public static void drawRectangles(Mat image, List<MatOfPoint> squares) {
