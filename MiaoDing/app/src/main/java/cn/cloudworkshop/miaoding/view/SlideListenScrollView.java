 ...
 * Describe：ScrollView滑动监听
 */
public class SlideListenScrollView extends ScrollView {

    private static final String TAG = SlideListenScrollView.class.getSimpleName();
    // 检查ScrollView的最终状态
     ...
     * @param context
     */
    public SlideListenScrollView(Context context) {
        super(context);
    }
     ...
     * @param attrs
     */
    public SlideListenScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private Handler checkStateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (lastT == getScrollY()) {
                ...
                onScrollListener.onScrollStateChanged(SlideListenScrollView.this,
