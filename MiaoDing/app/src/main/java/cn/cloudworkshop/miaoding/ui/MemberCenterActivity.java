...
import cn.cloudworkshop.miaoding.utils.CubePageTransformer;
    ...
    private void initView() {
        ...
        vpMemberRights.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int pos) {
                View view = LayoutInflater.from(MemberCenterActivity.this)
                        .inflate(R.layout.viewpager_item_member, null);
